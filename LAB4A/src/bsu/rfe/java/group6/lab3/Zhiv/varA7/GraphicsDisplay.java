...
public class GraphicsDisplay extends JPanel {
    ...
    private final ArrayList<double[][]> undoHistory;
    ...
    private final Rectangle2D.Double selectionRect;
    private final Font axisFont;
    private final Font areaFont;
    ...
    public GraphicsDisplay() {
        ...
        BasicStroke dashed = new BasicStroke(3, BasicStroke.CAP_BUTT, BasicStroke.CAP_BUTT,
                1, new float[]{30, 10, 30, 10, 30, 10, 10,10,10,10,10,10,}, 0);
